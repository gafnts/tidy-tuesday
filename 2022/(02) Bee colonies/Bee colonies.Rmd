...
plot %>% 
  ...
  geom_col() +
  labs(title = "This is a aweseme title \nexplaining what up", 
       subtitle = "And this is a explanation of the actual plot") + 
  scale_y_continuous(label = scales::comma,
                     breaks = seq(0, 8e6, by = 1e6)) + 
  scale_x_discrete(breaks = c(2015, 2016, 2017, 2018, 2019, 2020, 2021)) +
  theme(title = element_text(size = 40, face = "bold", color = "#F2F2F2"),
        plot.subtitle = element_text(size = 15, face = "bold", color = "gray"),
        axis.title.x = element_blank(),
        axis.text.x = element_text(color = "#F2F2F2", size = 17),
        axis.title.y = element_blank(),
        axis.text.y = element_text(color = "#F2F2F2", size = 17),
        ...
        plot.margin = margin(2.3, 2.3, 2.3, 2.3, "cm"),
