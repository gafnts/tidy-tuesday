...
```{r}
chord_diagram + 
  labs(title = "How did the <b style='color:#3D739C'>15 more voted countries</b> voted?", 
       subtitle = "Eurovision grand final\nTurin, 2022",
       caption = "Source: Data.World") +
  theme(
    text = element_text(family = "Circular Std Book"),
    plot.title = element_markdown(lineheight = 1.1, size = 15, 
                                  family = "Circular Std Black"),
    plot.subtitle = element_text(vjust = -1),
    plot.margin = margin(t = 0.375, r = .85, b = 0.375, l = .85, unit = "cm"),
