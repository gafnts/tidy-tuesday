...
final <- 
  plot +
  plot_annotation(
    title = "New York Times Best Sellers List",
    subtitle = "Even though the best rank that a title can achieve is, on average, directly related to\nthe number of weeks on the New York Times Best Sellers List, the rank with which the\nbook made it to the list has no relation with the amount of time is gonna stay there.",
